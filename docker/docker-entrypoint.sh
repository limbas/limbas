...
if [ -z "${LIMBAS_DB_HOST}" ]; then
  usesEnvVar=true
elif [ -z "${LIMBAS_DB_TYPE}" ]; then
  usesEnvVar=true
elif [ -z "${LIMBAS_DB_USER}" ]; then
  usesEnvVar=true
elif [ -z "${LIMBAS_DB_PASSWORD}" ]; then
  usesEnvVar=true
elif [ -z "${LIMBAS_HOST}" ]; then
  usesEnvVar=true
elif [ -z "${LIMBAS_DB_PORT}" ]; then
  usesEnvVar=true
elif [ -z "${LIMBAS_DB_VERSION}" ]; then
  usesEnvVar=true
fi
