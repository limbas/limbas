...
<div id="limbasDivMenuContextFolder" class="lmbContextMenu" style="position:absolute;visibility:hidden;z-index:991;" onclick="activ_menu = 1;">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <input name="file" type="file" id="fileA" onchange="fileChange();" multiple /><br>
        <input name="upload" value="Upload" type="button" onclick="uploadFileFromDesktop();" />
...
echo "<div class=\"topelement\" id=\"" . md5($umgvar['pfad'] . "/EXTENSIONS/") . "\"></div>";
echo "<script type=\"text/javascript\">lmb_getTree(\"" . $umgvar['pfad'] . "/EXTENSIONS/\",\"" . md5($umgvar['pfad'] . "/EXTENSIONS/") . "\",null);</script>";
