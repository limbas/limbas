...
<TR><TD><B><?=$lang[1321]?></B><BR><SELECT NAME="uploadfield" SIZE="25"><OPTION VALUE="ID" SELECTED>ID
<?
...
<?if($sum_ok){echo "<FONT COLOR=\"green\"><B>$sum_ok</B> files imported!</FONT><BR>";}?>
<?if($sum_false){echo "<FONT COLOR=\"red\"><B>$sum_false</B> files failed!</FONT><BR>";}?>
</TD>
</TR>
</TABLE>
</TD></TR></TABLE>
