...
function LmAdm_getFields(gtabid,actel,$parentrel){
	...
	if( eval("document.tab_"+actel+"_plusminus.src == pic_plusonly.src") ){
		...
		dynfunc = function(result){LmAdm_formTabFieldListPost(result,actel,gtabid,$parentrel);}
		actid = "formTabFieldList&gtabid=" + gtabid + "&parentrel="+ $parentrel;
...
// Ajax output
function LmAdm_formTabFieldListPost(result,actel,gtabid,$parentrel){
