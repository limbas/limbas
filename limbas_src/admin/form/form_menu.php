		...
		<TD>
			...
			<FORM ENCTYPE="multipart/form-data" ACTION="main_admin.php"
				...
				<input type="hidden" name="<? echo $_SID; ?>"
					value="<? echo session_id(); ?>"> <input type="hidden"
					name="action" value="setup_form_menu"> <input type="hidden"
					name="form_id" value="<? echo $form_id; ?>"> <input type="hidden"
					name="form_name" value="<? echo $form_name; ?>"> <input
					type="hidden" name="referenz_tab" value="<? echo $referenz_tab; ?>">
				<input type="hidden" name="form_id"
					value="<? echo $form["form_id"]; ?>"> <input type="hidden"
					name="form_typ" value="<? echo $form["form_typ"]; ?>"> <input
					type="hidden" name="form_add"> <input type="hidden" name="form_tab">
				<input type="hidden" name="form_tab_el"> <input type="hidden"
					name="objekt"> <input type="hidden" name="aktiv_id"> <input
					type="hidden" name="aktiv_tabcontainer"> <input type="hidden"
					name="aktiv_tabulator"> <input type="hidden" name="form_dimension">
				...
				<TABLE class="formeditorPanel" cellspacing="0" cellpadding="2">
					...
					<TR>
						<TD VALIGN="TOP"><b><?= $lang[1182] ?></TD>
						<TD><? if ($form["form_typ"] == 1) {
    echo $lang[1183];
} else {
    echo $lang[1184];
} ?></TD>
				...
				<TABLE class="formeditorPanel" cellspacing="0" cellpadding="2">
					...
					<TR>
						...
						<TD><INPUT STYLE="border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;width:40px;height:13px;" NAME="XPOSI" OnChange="parent.form_main.posxy_change(this.value, '');"></TD>
						<TD>&nbsp;&nbsp;&nbsp;&nbsp;<B>W:</B>&nbsp;&nbsp;
						</TD>
						<TD><INPUT TYPE="TEXT" STYLE="border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;width:40px;height:13px;" NAME="WPOSI" OnChange="parent.form_main.sizexy_change('', this.value);"></TD>
					</TR>
					<TR>
						<TD STYLE="height: 14px;"><B>Y:</B></TD>
						<TD><INPUT STYLE="border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;width:40px;height:13px;" NAME="YPOSI" OnChange="parent.form_main.posxy_change('', this.value);"></TD>
						<TD>&nbsp;&nbsp;&nbsp;&nbsp;<B>H:</B>&nbsp;&nbsp;
						</TD>
						<TD><INPUT TYPE="TEXT" STYLE="border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;width:40px;height:13px;" NAME="HPOSI" OnChange="parent.form_main.sizexy_change(this.value, '');"></TD>
					</TR>
					</TD>
					</TR>
				</TABLE>
				...
				<TABLE cellspacing="0" cellpadding="2" class="formeditorPanel">
					<TR>
						<TD class="formeditorPanelHead" COLSPAN="3" align="center"><?= $lang[2781] ?></TD>
					</TR>
					...
					<TR>
						<TD><?= $lang[1170] ?>:</TD>
						<TD VALIGN="TOP" ALIGN="right"><SELECT NAME="default_font" STYLE="border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;width:70;height:14;">
<?
...
?>
						...
						<TD VALIGN="TOP"><INPUT TYPE="TEXT"
							STYLE="width: 30px; height: 15px;" NAME="default_size" VALUE=""></TD>
					</TR>
					...
					<TR>
						...
						<TD VALIGN="TOP" ALIGN="right"><input id="formX" type="text" OnChange="document.form1.form_dimension.value = this.value + 'x' + document.getElementById('formY').value;
                            document.form1.submit();" STYLE="width:30px;border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;" VALUE="<?php echo $form["dimension"][0]; ?>"></TD>
						<TD><input id="formY" OnChange=" document.form1.form_dimension.value = document.getElementById('formX').value + 'x' + this.value;
                                    document.form1.submit();" type="text" STYLE="width:30px;border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;" VALUE="<?php echo $form["dimension"][1]; ?>"></TD>
					...
					<TR>
						...
						<TD><INPUT TYPE="TEXT" NAME="raster" VALUE="10" STYLE="width:30px;border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB8]; ?>;"></TD>
					</TR>
					<TR>
						<TD COLSPAN="2"><?= $lang[1148] ?>:</TD>
						<TD><INPUT TYPE="CHECKBOX" NAME="prop" STYLE="border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB7]; ?>;"></TD>
					</TR>
					<TR>
						<TD COLSPAN="2"><?= $lang[2063] ?>:</TD>
						<TD><INPUT TYPE="CHECKBOX" NAME="set_zindex" STYLE="border:none;BACKGROUND-COLOR:<? echo $farbschema[WEB7]; ?>;"></TD>
					</TR>
					<TR>
                ...
                <? if ($form["form_typ"] == 2) { ?>
					...
					<TR>
						<TD HEIGHT="25">&nbsp;<?= $lang[2456] ?>:&nbsp;<SELECT
							STYLE="width: 150px;" NAME="form_redirect"
							OnChange="parent.form_main.document.form1.form_redirect.value = this.value;parent.form_main.document.form1.submit();"><OPTION
									VALUE="0">
    <?
    $bzm = 0;
...
OnMouseUp="pressbutton('php', 'outset', '<? echo $farbschema[WEB7]; ?>');add('php');send();"></i>
				...
				<div ID="new_bild_area" style="display: none;">
					<TABLE class="formeditorPanel" cellspacing="0" cellpadding="2">
						...
						<TR>
							<TD colspan="2" HEIGHT="25"><INPUT TYPE="FILE" NAME="new_pic" SIZE="20" STYLE="width:200px;background-color:<? echo $farbschema["WEB7"]; ?>;height:17px;"></TD>
						</TR>
						...
						<TR ID="send_bild_area" style="display: none;">
							<TD STYLE="height: 30px;" VALIGN="CENTER">&nbsp;<SPAN ID="uploadlevel" STYLE="width:1px;height:15px;border:2px inset grey;background-color:<? echo $farbschema[WEB10]; ?>">&nbsp;</SPAN></TD>
						</TR>
					</TABLE>
					<BR>
				</div>
					...
					<TABLE cellspacing="0" cellpadding="0"
						...
						<TR>
							<TD COLSPAN="2" VALIGN="TOP">&nbsp;snapshot:<BR> &nbsp;<SELECT
								NAME="stab_snap_id" STYLE="width: 190px"><OPTION>
<?
...
?>
						...
						<TR BGCOLOR="<? echo $farbschema["WEB7"]; ?>">
							<TD>&nbsp;tabulator:</TD>
						...
						<TR>
							<TD BGCOLOR="<? echo $farbschema[WEB7]; ?>" VALIGN="TOP">
								...
								<div style="padding: 2px;"><?= $lang[1569] ?>:<BR> <SELECT
										NAME="uform_style" STYLE="width: 190px">
										<OPTION VALUE="1">iframe
										
										<OPTION VALUE="2">div s
									
									</SELECT>
								</div>

								<div style="padding: 2px;"><?= $lang[1177] ?>:<BR> <SELECT
										NAME="uform_typ" STYLE="width: 190px"
...
?>
				...
				<div ID="new_dbdat_area" style="display: none;">
					<TABLE class="formeditorPanel no-padding" cellspacing="0"
						cellpadding="2">
						<TR>
...
?>
				...
				<TABLE cellspacing="0" cellpadding="0" class="formeditorPanel">
					...
					<TR>
						<TD STYLE="height: 15px" ALIGN="CENTER"><INPUT TYPE="BUTTON"
							STYLE="border: 1px solid grey; cursor: pointer"
							VALUE="<?= $lang[2515] ?>" OnCliCk="send();"></TD>
					</TR>
				</TABLE>
				...
				<div ID="itemlist_area" class="formeditorPanel"
