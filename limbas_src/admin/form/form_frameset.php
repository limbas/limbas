...
if($form_id){
    ...
    <div class="frame-container">
        ...
        <iframe name="form_menu" src="main_admin.php?&action=setup_form_menu&form_id=<?=$form_id?>&form_name=<?=$form_name?>&form_typ=<?=$form_typ?>&referenz_tab=<?=$referenz_tab?>" style="width: 240px;"></iframe>
    </div>
	<?php
}else{
