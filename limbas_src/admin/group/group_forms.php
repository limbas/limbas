...
<?if($LINK[291]){?><TR class="tabHpoolItemTR"><TD class="tabHpoolItemActive" OnClick="<?=$LINK["link_url"][291]?>" TITLE="<?=$lang[$LINK["desc"][291]]?>"><?echo "<i style=\"float:left;\" class=\"lmb-icon ".$LINK["icon_url"][291]."\"></i>&nbsp;".$lang[$LINK["name"][291]];?></TD></TR><?}?>
...
<TR class="tabHeader"><TD class="tabHeaderItem"><i class="lmb-icon-cus lmb-icon-8 lmb-form"></i>&nbsp;<b><?=$lang[2281]?></b></TD><TD class="tabHeaderItem"><?=$lang[2514]?></TD><TD class="tabHeaderItem"><?=$lang[2513]?></TD></TR>
<?php
if($rulelist_){
