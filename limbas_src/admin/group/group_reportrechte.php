...
<?if($LINK[260]){?><TR class="tabHpoolItemTR"><TD class="tabHpoolItemActive" OnClick="<?=$LINK["link_url"][260]?>" TITLE="<?=$lang[$LINK["desc"][260]]?>"><?echo "<i style=\"float:left;\" class=\"lmb-icon ".$LINK["icon_url"][260]."\"></i>&nbsp;".$lang[$LINK["name"][260]];?></TD></TR><?}?>
...
<TR class="tabHeader"><TD class="tabHeaderItem"><i class="lmb-icon-8 lmb-report"></i>&nbsp;<?=$lang[2280]?></TD><TD class="tabHeaderItem"><?=$lang[2514]?></TD><TD class="tabHeaderItem"><?=$lang[2513]?></TD></TR>
<?php
