...
<?if($LINK[292]){?><TR class="tabHpoolItemTR"><TD class="tabHpoolItemActive" OnClick="<?=$LINK["link_url"][292]?>" TITLE="<?=$lang[$LINK["desc"][292]]?>"><?echo "<i style=\"float:left;\" class=\"lmb-icon ".$LINK["icon_url"][292]."\"></i>&nbsp;".$lang[$LINK["name"][292]];?></TD></TR><?}?>
...
<TR class="tabHeader"><TD class="tabHeaderItem"><i class="lmb-icon-8 lmb-line-chart"></i>&nbsp;<b><?=$lang[2282]?></b></TD><TD class="tabHeaderItem"><?=$lang[2514]?></TD><TD class="tabHeaderItem"><?=$lang[2513]?></TD></TR>
<?
if($rulelist_){
