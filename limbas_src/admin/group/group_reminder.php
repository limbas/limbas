...
<?if($LINK[290]){?><TR class="tabHpoolItemTR"><TD class="tabHpoolItemActive" OnClick="<?=$LINK["link_url"][290]?>" TITLE="<?=$lang[$LINK["desc"][290]]?>"><?echo "<i style=\"float:left;\" class=\"lmb-icon ".$LINK["icon_url"][290]."\"></i>&nbsp;".$lang[$LINK["name"][290]];?></TD></TR><?}?>
...
<TR class="tabHeader"><TD class="tabHeaderItem"><i class="lmb-icon-8 lmb-bell-key"></i>&nbsp;<b><?=$lang[2743]?></b></TD><TD class="tabHeaderItem"><?=$lang[2514]?></TD><TD class="tabHeaderItem"><?=$lang[2513]?></TD></TR>
<?
if($rulelist_){
