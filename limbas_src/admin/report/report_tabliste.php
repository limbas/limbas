...
// Ajax output
function LmAdm_reportTabFieldListPost(result,actel,gtabid,$parentrel){
...
function tabpool($gtabid){
	...
	foreach ($gtab["raverkn"][$gtab["verkn"][$gtabid]] as $key => $value){
		...
		echo "<TR><TD><A HREF=\"Javascript:LmAdm_getFields('$value','$globid','')\"><IMG SRC=\"pic/outliner/plusonly.gif\" WIDTH=\"18\" HEIGHT=\"16\" ALIGN=\"TOP\" BORDER=\"0\" NAME=\"tab_".$globid."_plusminus\"><i class=\"lmb-icon lmb-folder-closed\" WIDTH=\"16\" HEIGHT=\"13\" ALIGN=\"TOP\" BORDER=\"0\" NAME=\"tab_".$globid."_box\"></i></A> <B>".$gtab["desc"][$value]."</B></TD></TR>\n";
