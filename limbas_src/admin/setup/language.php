...
<?php if($language_id AND $list){?>
	...
	<TR class="tabHeader">
	<TD class="tabHeaderItem"><A HREF="#" OnClick="document.form1.order.value='ELEMENT_ID';document.form1.submit();"><?=$lang[949]?></A></TD>
    <TD class="tabHeaderItem"><A HREF="#" OnClick="document.form1.order.value='EDIT';document.form1.submit();"><?=$lang[1205]?></A> </TD>
    <TD class="tabHeaderItem"><A HREF="#" OnClick="document.form1.order.value='LANGUAGE';document.form1.submit();"><?=$lang[624]?></A> </TD>
	<TD class="tabHeaderItem"><A HREF="#" OnClick="document.form1.order.value='TYP';document.form1.submit();"><?=$lang[925]?></A> </TD>
	<TD class="tabHeaderItem"><A HREF="#" OnClick="document.form1.order.value='FILE';document.form1.submit();"><?=$lang[545]?></A> </TD>
    <TD class="tabHeaderItem"><A HREF="#" OnClick="document.form1.order.value='REF';document.form1.submit();"><?=$lang[29]?></A></TD>
    <TD class="tabHeaderItem"><A HREF="#" OnClick="document.form1.order.value='WERT';document.form1.submit();"><?=$lang[29]?></A> </TD>
	...
	<OPTION VALUE="a" <?php if($EDIT == 'a'){echo "SELECTED";}?>><?=$lang[994]?>
	<OPTION VALUE="FALSE" <?php if($EDIT == 'FALSE'){echo "SELECTED";}?>><?=$lang[1217]?>
	<OPTION VALUE="TRUE" <?php if($EDIT == 'TRUE'){echo "SELECTED";}?>><?=$lang[1218]?>
	</SELECT></TD>
	...
	<OPTION VALUE="0" <?php if($TYP == 0){echo "SELECTED";}?>><?=$lang[994]?>
	...
	<TD VALIGN="TOP" ALIGN="center" WIDTH="5" STYLE="width:5"><INPUT TYPE="checkbox" name="JS" OnChange="document.form1.submit();" <?php if($JS){echo "checked";}?>></TD>
    ...
    foreach($result_ref["element_id"] as $val){
		...
		?>
			<TR class="tabBody">
			<TD VALIGN="TOP">&nbsp;<?= $result_el["element_id"][$val] ?>&nbsp;</TD>
            <TD VALIGN="TOP" ALIGN="CENTER">&nbsp;<?php if($result_el["edit"][$val] == 1){echo "<i class=\"lmb-icon lmb-aktiv\"></i>";}else{echo "<i class=\"lmb-icon lmb-erase\"></i>";}?>&nbsp;</TD>
            <TD VALIGN="TOP">&nbsp;<?= $result_el["language"][$val] ?>&nbsp;</TD>
            <TD VALIGN="TOP"><?= $result_el["typ"][$val] ?></TD>
            <TD VALIGN="TOP"><?= $result_el["file"][$val] ?></TD>
            <TD VALIGN="TOP"><?= $result_ref["wert"][$val] ?></TD>
            <TD VALIGN="TOP"><TEXTAREA style="width:250px;" NAME="new_value[<?=$result_el["id"][$val]?>]" OnChange="document.form1.is_value.value=document.form1.is_value.value+';<?=$result_el["id"][$val]?>'"><?= htmlentities($result_el["wert"][$val],ENT_QUOTES,$umgvar["charset"]) ?></TEXTAREA></TD>
    ...
    </select></TD><TD COLSPAN="2"><INPUT TYPE="submit" VALUE="<?=$lang[522]?>" NAME="change" style="width:100px;"></TD></TR>
    <TR><TD COLSPAN="9"><HR></TD></TR>
    <TR>
    <TD></TD>
    <TD></TD>
    ...
    <TD COLSPAN="2"><INPUT TYPE="submit" VALUE="<?=$lang[540]?>" NAME="add" style="width:100px;"></TD>
    </TR>
...
<?php }else{
    ...
    echo "<TR class=\"tabSubHeader\"><TD width=\"5\" class=\"tabHeaderItem\">default</TD><TD class=\"tabHeaderItem\">$lang[624]</TD><TD class=\"tabHeaderItem\">$lang[1205]</TD>$mheader<TD>&nbsp;</TD></TR>";
    ...
    foreach ($result_language["language_id"] as $bzm => $lval){
        ...
        echo "<TD ALIGN=\"CENTER\"><A HREF=main_admin.php?action=setup_language&del_lang=1&language_id=".$result_language["language_id"][$bzm]."&language_typ=$language_typ><i class=\"lmb-icon lmb-trash\" BORDER=\"0\"></i></A></TD>";
        echo "</TR>";
    }
    echo "<TR><TD></TD><TD>&nbsp;</TD></TR>";
    echo "<TR><TD></TD><TD><INPUT TYPE=\"TEXT\" SIZE=\"15\" NAME=\"add_lang\"></TD><TD><INPUT TYPE=\"submit\" VALUE=\"$lang[540]\"></TD></TR>";
    ...
    echo "<TR><TD COLSPAN=\"2\" ALIGN=\"RIGHT\"><INPUT TYPE=\"SUBMIT\" VALUE=\"$lang[1040]\"></TD></TR></TABLE>";
