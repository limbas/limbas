...
<TABLE class="tabpool" BORDER="0" width="700" cellspacing="0" cellpadding="0"><TR><TD>
	...
	<TR class="tabHeader"><TD></TD><TD class="tabHeaderItem">ID</TD><TD class="tabHeaderItem"><?=$lang[4]?></TD>
    ...
    <?php
        ...
        <TR class=\"tabBody\"><TD></TD><TD><INPUT TYPE=\"submit\" VALUE=".$lang[522]." NAME=\"edit_multitenant\"></TD></TR>
