...
<TABLE class="tabpool" BORDER="0" width="800" cellspacing="0" cellpadding="0"><TR><TD>
	...
	<TD nowrap <?if($keytype == 1){echo "class=\"tabpoolItemActive\"";}else{echo "class=\"tabpoolItemInactive\"";}?> onclick="document.location.href='main_admin.php?action=setup_keymanager&keytype=1'">Public Key</TD>
    <TD nowrap <?if($keytype == 2){echo "class=\"tabpoolItemActive\"";}else{echo "class=\"tabpoolItemInactive\"";}?> onclick="document.location.href='main_admin.php?action=setup_keymanager&keytype=2'">Private Key</TD>
