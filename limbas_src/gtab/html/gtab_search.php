...
<br>
<link href="extern/select2-4.0.13/dist/css/select2.min.css" rel="stylesheet">
            ...
            customDropdown.prototype.render = function() {
                ...
                const $header = $(
                    `<div class="border-bottom border-secondary d-flex justify-content-between">
                        <span class="flex-basis-50 text-left">${button}</span>
        ...
        return function(state) {
            ...
            return $(
                `<div class="select2-results__option--link d-flex justify-content-between">
                    <span title="${state.title}" class="select2-results__option--link__text font-weight-bold">${state.text}</span>
                    ${paramsButton}
