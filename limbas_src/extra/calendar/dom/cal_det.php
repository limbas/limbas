...
<OPTION VALUE="1" <?if($termin[typ] == 1){echo "SELECTED";}?>><?=$lang[1440]?>
<OPTION VALUE="2" <?if($termin[typ] == 2){echo "SELECTED";}?>><?=$lang[1441]?>
<OPTION VALUE="3" <?if($termin[typ] == 3){echo "SELECTED";}?>><?=$lang[1442]?>
</SELECT></TD></TR>
...
<TR><TD VALIGN="TOP"><B><?=$lang[1444]?></B>&nbsp;</TD><TD><INPUT TYPE="CHECKBOX" NAME="inp_alert" VALUE="1" STYLE="background-color:transparent;border:none;" <?if($termin[alert]){echo "CHECKED";}?>></TD></TR>
<TR><TD COLSPAN="2">&nbsp;</TD></TR>
<TR><TD VALIGN="TOP">&nbsp;</TD><TD><INPUT TYPE="SUBMIT" NAME="inp_change" VALUE="<?=$lang[1450]?>!">&nbsp;&nbsp;<INPUT TYPE="SUBMIT" NAME="inp_del" VALUE="<?=$lang[1451]?>"></TD></TR>
</TABLE>
</FORM>
</TD></TR></TABLE>