...
<TABLE BORDER="0" cellpadding="0" cellspacing="0" WIDTH="100%" style="position:absolute;top:30px;left:20px;"><TR><TD>
...
<TABLE BORDER="0" cellpadding="0" cellspacing="1" WIDTH="93%"><TR bgcolor="<?=$farbschema[WEB6]?>">
<TD WIDTH="18" HEIGHT="20">&nbsp;</TD>
<TD STYLE="border-bottom:1px solid grey; border-right:1px solid grey; cursor:pointer;" WIDTH="70" ALIGN="CENTER" ID="new" OnMouseOver="activate('new','bold') ;" OnMouseOut="activate('new','normal');" OnClick="view('new','el_create','tag')"><?=$lang[1434]?></TD>
...
<?if($type != "tab"){?><TR><TD VALIGN="TOP"><B><?=$lang[1449]?></B>&nbsp;</TD><TD><SELECT NAME="inp_typ" STYLE="width:120px">
<OPTION VALUE="1" <?if($inp_typ == 1){echo "SELECTED";}?>><?=$lang[1440]?>
<OPTION VALUE="2" <?if($inp_typ == 2){echo "SELECTED";}?>><?=$lang[1441]?>
<OPTION VALUE="3" <?if($inp_typ == 3){echo "SELECTED";}?>><?=$lang[1442]?>
</SELECT></TD></TR><?}?>
...
<?if($type != "tab"){?><TR><TD VALIGN="TOP"><B><?=$lang[1444]?></B>&nbsp;</TD><TD><INPUT TYPE="CHECKBOX" NAME="inp_alert" VALUE="1" STYLE="background-color:transparent;border:none;" <?if($inp_alert){echo "CHECKED";}?>></TD></TR><?}?>
