...
<div style="position:absolute;top:13px;left:650px"><img src="pic/en.gif" OnClick="document.form1.lng.value='2';document.form1.submit();">&nbsp;<img src="pic/de.gif" OnClick="document.form1.lng.value='1';document.form1.submit();"></div>
