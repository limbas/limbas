...
function olInlineAudio(id, swf, width, height, baseurl){
	this.play = function(){
		$('olInlineAudio_play').style.display = 'none';
		$('olInlineAudio_stop').style.display = 'block';
		this.cmd("play", arguments[0] ? arguments[0] : 0);
	};
	this.stop = function(){
		$('olInlineAudio_stop').style.display = 'none';
		$('olInlineAudio_play').style.display = 'block';
		this.onMessage('');
		this.cmd("stop", "");
	};
