...
function olContextMenuItem(title, parent, image, action){
	...
	this._registerEventHandlers = function(){
		...
		_self.parent.eventHandler.observe(_self.el, "mouseover", function(e){
			_self.el.style.textDecoration = "underline";
		});
		_self.parent.eventHandler.observe(_self.el, "mouseout", function(e){
			_self.el.style.textDecoration = "none";
		});
	};
