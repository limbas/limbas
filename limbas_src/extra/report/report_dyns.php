...
function dyns_lmbGetReportList($params) {
    ...
    require_once 'extra/report/report_select/report_select.php';
...
function lmbSaveReportTemplate($gtabid, $report_id,$saveAsTemplate,$resolvedTemplateGroups) {
    ...
    $noReportFrameSet = true;

    require_once 'admin/report/report_frameset.php';

    lmb_insertNewReport($saveAsTemplate,'','',$gtabid,$reportextension,'','tcpdf',$report_id,$resolvedTemplateGroups);
}
