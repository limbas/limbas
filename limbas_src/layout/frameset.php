...
if($umgvar["introlink"]){$intro = $umgvar["introlink"];}else{$intro = "main.php?".SID."&action=intro";}
...
<FRAMESET ID="topset" ROWS="<?=$topset?>" Border="0" FRAMEBORDER="0" FRAMESPACING="0">
	...
	<FRAMESET ID="mainset" COLS="<?=$navset?>" Border="0" FRAMEBORDER="0" FRAMESPACING="0">
		...
		<?}?>
			<FRAMESET rows="41,*" FRAMEBORDER="0" FRAMESPACING="0" BORDER="0">
		...
		<?if($LINK[253] AND $session["multiframe"]){?>
