...
function mail_foldertoggle(id){
	...
	togbox.src = shown ? 'assets/images/legacy/outliner/plusonly.gif' : 'assets/images/legacy/outliner/minusonly.gif';
        folderpic.src = shown ? 'assets/images/legacy/outliner/box_close.gif' : 'assets/images/legacy/outliner/box_open.gif';
	return false;
}
