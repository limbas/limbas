	...
	if(cookieresult){
		...
		for (var key in c_el){
			...
			if(el[1] == 'c'){
				...
				img1.src = "assets/images/legacy/plus.gif";
			}else{
				var img1 = document.createElement("img");
				img1.id = el[1]+","+el[0]+","+el[4]+","+el[2]+",0";
				img1.src = "assets/images/legacy/right.gif";
			}

			if(el[4] == '#'){
				var img4 = document.createElement("img");
				img4.id = el[1]+","+el[0]+","+el[4]+","+el[2]+",1";
				img4.src = "assets/images/legacy/small_file.gif";
			}else if(el[4] == '&'){
				var img4 = document.createElement("img");
				img4.id = el[1]+","+el[0]+","+el[4]+","+el[2]+",2";
				img4.src = "assets/images/legacy/small_mail.gif";
			}else if(el[4] == '*'){
				var img4 = document.createElement("img");
				img4.id = el[1]+","+el[0]+","+el[4]+","+el[2]+",3";
				img4.src = "assets/images/legacy/small_ordner.gif";
			}
