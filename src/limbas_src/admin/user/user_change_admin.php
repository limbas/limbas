    ...
    <FORM ENCTYPE="multipart/form-data" ACTION="main_admin.php" METHOD="post" NAME="form1">
        ...
        <div class="container-fluid bg-white p-3 border">
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[username]" value="<?=$result_user["username"]?>" <?=($action != "setup_user_neu")?'OnChange="alert(\'for change username, you need to set a password again!\');"':''?>>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group input-group-sm mb-3">
                                <input type="password" class="form-control form-control-sm" name="userdata[passwort]" value="<?=$pass?>">
                                <span class="input-group-text"><i class="lmb-icon lmb-lock-file cursor-pointer" OnClick="createpass();"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[vorname]" value="<?=$result_user['vorname']?>">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label"><?=$lang[4]?></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[name]" value="<?=$result_user['name']?>">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label"><?=$lang[612]?></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[email]" value="<?=$result_user['email']?>">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Tel</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[tel]" value="<?=$result_user['tel']?>">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Fax</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[fax]" value="<?=$result_user['fax']?>">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Position</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[position]" value="<?=$result_user['position']?>">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label"><?=$lang[126]?></label>
                        <div class="col-sm-8">
                            <textarea name="userdata[beschreibung]" class="form-control" ><?=htmlentities($result_user["beschreibung"],ENT_QUOTES,$umgvar["charset"])?></textarea>
                        </div>
                    </div>
                                ...
                                <div class="col-10">
                                    ...
                                    if(is_array($result_user["sub_group"])):
                                        foreach ($result_user["sub_group"] as $key => $value): ?>
                                            <a href="main_admin.php?action=setup_group_erg&ID=<?=$value?>"><?=$groupdat["name"][$value]?></a><br>
                                        <?php endforeach;
                                    endif;
                                    ?>
                                </div>
                                                ...
                                                <div class="dropdown-item" title="<?=$mid?>">
                                                    <div class="form-check">
                                                        <label class="form-check-label">
                                                            <input class="form-check-input mt-0" type="checkbox" value="<?=$id?>" name="userdata[multitenant][]" <?=($id && is_array($result_user["multitenant"]) && in_array($id,$result_user["multitenant"]))?'checked':''?>>
                                                            <?=$mname?>
                                                        </label>
                                                    </div>
                                                </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <TEXTAREA NAME="userdata[iprange]" class="form-control form-control-sm"><?=$result_user['iprange']?></TEXTAREA>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label">Farbkennung</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[usercolor]" value="<?=$result_user['usercolor']?>" style="background-color:#<?=$result_user["usercolor"]?>; color:<?=lmbSuggestColor('#' . $result_user['usercolor'])?>">
                        </div>
                    </div>
                    
                    <div>
                        <?php if(file_exists(USERPATH."portrait/portrait_$ID.jpg")){?><IMG SRC="USER/portrait/portrait_<?=$ID?>.jpg" BORDER="1"><?php }?>
                    </div>
                ...
                <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control form-control-sm" name="userdata[validdate]" value="<?=$result_user['validdate']?>">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control form-control-sm" name="userdata[gc_maxlifetime]" value="<?=$result_user['gc_maxlifetime']?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[timezone]" value="<?=$result_user['timezone']?>">
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-4 col-form-label"><?=$lang[902]?></label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[setlocale]" value="<?=$result_user['setlocale']?>">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="userdata[maxresult]" value="<?=$result_user['maxresult']?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control form-control-sm" name="userdata[uploadsize]" value="<?=$result_user['uploadsize']?>">
                    ...
                    <h5><?=$lang[1780]?></h5>
                        ...
                        <?php if ($ID != 1): ?>
                            <div class="row">
                                <label class="col-sm-4 col-form-label"><?=$lang[1781]?></label>
                                <div class="col-sm-8">
                                    <TEXTAREA NAME="userdata[locktxt]" class="form-control form-control-sm"><?=$result_user['locktxt']?></TEXTAREA>
                                </div>
                            </div>
                            <div class="row">
                                <label class="col-sm-4 col-form-label"><?=$lang[657]?></label>
                                <div class="col-sm-8">
                                    <INPUT TYPE="CHECKBOX" OnClick="document.form1.lock.value='1';" <?=($result_user['lock'])?'checked':''?>>
                                </div>
                            </div>
                        <?php endif; ?>

                        <div class="row">
                            <label class="col-sm-4 col-form-label"><?=$lang[2088]?></label>
                            <div class="col-sm-8">
                                <INPUT TYPE="CHECKBOX" NAME="userdata[hidden]" <?=($result_user['hidden'])?'checked':''?>>
                            </div>
                        </div>

                        <?php if($session['superadmin'] AND $ID != 1): ?>
                            <div class="row">
                                <label class="col-sm-4 col-form-label">Superadmin</label>
                                <div class="col-sm-8">
                                    <INPUT TYPE="CHECKBOX" NAME="userdata[superadmin]" <?=($result_user['superadmin'])?'checked':''?>>
                                </div>
                            </div>
                    
                        <?php endif; ?>
                        <div class="row">
                            <label class="col-sm-4 col-form-label"><?=$lang[911]?></label>
                            <div class="col-sm-8">
                                <INPUT TYPE="CHECKBOX" OnClick="document.form1.debug.value='1';" <?=($result_user['debug'])?'checked':''?>>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label"><?=$lang[2353]?></label>
                            <div class="col-sm-8">
                                <INPUT TYPE="CHECKBOX" NAME="userdata[staticip]" <?=($result_user['staticip'])?'checked':''?>>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label"><a OnClick="srefresh()" href=#><?=$lang[904]?></a></label>
                            <div class="col-sm-8">
                                <i class="lmb-icon lmb-application-refresh cursor-pointer" OnClick="srefresh()"></i>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label"><a OnClick="newwin1('<?=$ID?>')" href=#><?=$lang[1250]?></a></label>
                            <div class="col-sm-8">
                                <i class="lmb-icon lmb-history cursor-pointer" OnClick="newwin1('<?=$ID?>')"></i>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label"><a OnClick="newwin2('<?=$ID;?>')" href=#><?=$lang[1791]?></a></label>
                            <div class="col-sm-8">
                                <i class="lmb-icon lmb-calendar-alt2 cursor-pointer" OnClick="newwin2('<?=$ID;?>')"></i>
                            </div>
                        </div>
            ...
            <div class="mt-3 pt-3 border-top">
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-primary btn-sm" OnClick="send('<?=$action?>');"><?=$lang[522]?></button>
                    ...
                    <div class="col">
                        <?php if($result_user["username"] != 'admin' AND $session["group_id"] == 1 AND $ID):?>
                            <button type="button" class="btn btn-outline-danger btn-sm" OnClick="delete_user('<?= $result_user["user_id"] ?>','<?= $result_user["username"] ?>')"><?=$lang[160]?></button>
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value="1" name="delete_user_files" checked>
                                    <?=$lang[1481]?>
                                </label>
                            </div>
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" value="1" name="delete_user_total">
                                    <?=$lang[1727]?>
                                </label>
                            </div>
