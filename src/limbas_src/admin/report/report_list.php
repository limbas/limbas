                            ...
                            <tr <?=($value == $newreport_id)?'class="alert alert-success"':''?>>
                                ...
                                <td>
                                    <?php if(!$greport[$gtabid]["grouplist"][$key] AND !$greport[$gtabid]["extension"][$key]){ ?>
                                        <a href="main_admin.php?action=setup_report_frameset&report_id=<?=$key?>&referenz_tab=<?=$gtabid?>&type=report"><i class="lmb-icon lmb-pencil cursor-pointer"></i></a>
                                    <?php } ?>
                                </td>
                                ...
                                <td nowrap>
                                    ...
                                    <SELECT OnChange="document.getElementById('report_changetarget_<?=$key?>').value=this.value;document.form1.changetarget_id.value='<?=$key?>';document.form1.action='main_admin.php';document.form1.action.value='setup_report_select';document.form1.submit();" style="width:150px !important;" class="form-select form-select-sm">
