...
<?php pop_checkbox("input_line_reverse_","fill_style('25','',this.checked)","input_line_reverse",null,null,null,$lang[1108])?>
</TD></TR>
<?php
$opt['val'] = array(); $opt['val'] = range(1, 100);array_unshift($opt['val'],'');
$opt['desc'] = array(); $opt['desc'] = range(1, 100);array_unshift($opt['desc'],'');
?>
...
<?php
$opt['val'] = array(); $opt['val'] = range(0, 30);
$opt['desc'] = array(); $opt['desc'] = range(0, 30);
?>
...
<?php pop_checkbox("input_list","fill_style('33','',this.checked)","input_list",null,null,null,$lang[1114])?>
</TD></TR>
<TR id="menu_dbdat_bild_onlynotab_" STYLE="display:none"><TD>
<?php pop_checkbox("input_prop","fill_style('26','',this.checked)","input_prop",null,null,null,$lang[1463])?>
</TD></TR>
<TR id="menu_text_bild_templ_datum_dbdat_dbdesc_rect_line_ellipse_snr_formel_onlynotab_" STYLE="display:none;"><TD>
<?php pop_checkbox("input_head","fill_style('27','',this.checked)","input_head",null,null,null,$lang[1112])?>
</TD></TR>
<TR id="menu_text_bild_templ_datum_dbdat_dbdesc_rect_line_ellipse_snr_formel_onlynotab_" STYLE="display:none;"><TD>
<?php pop_checkbox("input_foot","fill_style('28','',this.checked)","input_foot",null,null,null,$lang[1113])?>
</TD></TR>
<TR id="menu_text_bild_datum_dbdat_dbdesc_rect_line_ellipse_snr_formel_onlynotab_" STYLE="display:none;"><TD>
<?php pop_checkbox("input_breaklock","fill_style('35','',this.checked)","input_breaklock",null,null,null,$lang[2101])?>
</TD></TR>
<TR id="menu_text_formel_onlynotab_" STYLE="display:none"><TD>
<?php pop_checkbox("input_html","fill_style('42','',this.checked)","input_html",null,null,null,$lang[2508])?>
</TD></TR>

<TR id="menu_templ_dbdat_" STYLE="display:none"><TD><?php pop_line();?></TD></TR>

<TR id="menu_dbdat_" STYLE="display:none"><TD>
<?php pop_checkbox("replace_element","if(this.checked){document.form1.report_replace_element.value=document.form1.report_edit_id.value;}else{document.form1.report_replace_element.value=''}","replace_element",null,null,null,$lang[2460])?>
</TD></TR>
<TR id="menu_text_dbdat_formel_onlytab_" STYLE="display:none"><TD>
<?php pop_checkbox("input_tagmode","fill_style('41','',this.checked)","input_tagmode",null,null,null,'tagmode')?>
...
function printBerichtElement($report,$key){
	...
	if($tab_el_type=="text"){
		...
		$tagType = "textarea";
        if ($tab_el_type == 'templ') {
		    $tagType .= ' title="' . $gtab['desc'][$report_pictype] . '"';
        }
		$textAreaIdTyp = "div";
		$content = htmlentities($report_value,ENT_QUOTES,$GLOBALS["umgvar"]["charset"]);
