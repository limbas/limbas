...
function tabpool($gtabid){
	...
	foreach ($gtab["raverkn"][$gtab["verkn"][$gtabid]] as $key => $value){
		...
		echo "<TR><TD><A HREF=\"Javascript:LmAdm_getFields('$value','$globid','')\"><IMG class=\"lmb-image-as-icon\" SRC=\"assets/images/legacy/outliner/plusonly.gif\" WIDTH=\"18\" HEIGHT=\"16\" ALIGN=\"TOP\" BORDER=\"0\" NAME=\"tab_".$globid."_plusminus\"><i class=\"lmb-icon lmb-folder-closed\" WIDTH=\"16\" HEIGHT=\"13\" ALIGN=\"TOP\" BORDER=\"0\" NAME=\"tab_".$globid."_box\"></i></A> <B>".$gtab["desc"][$value]."</B></TD></TR>\n";
