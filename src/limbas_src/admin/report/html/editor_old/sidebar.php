...
function resetmenu(){
        ...
        <?php }
        if($greportlist[$referenz_tab]["defformat"][$report_id] == 'tcpdf' || $greportlist[$referenz_tab]["defformat"][$report_id] == 'mpdf'){ #REPTYPE# ?>
...
function send() {
	...
	parent.report_main.document.form1.default_size.value = document.form1.default_font_size.value;
...
<?php if($report["defformat"] == 'tcpdf' || $report["defformat"] == 'mpdf'){ #REPTYPE# ?>
<TR>
    <TD><?= $lang[2581] ?></TD>
    <TD COLSPAN="3">
        <select name="default_class" onchange="document.form1.submit();" style="width:100px;">
            ...
            <option value="<?=e($pathParts['basename'])?>" <?=$pathParts['basename'] === $report['css'] ? 'selected' : ''?>><?=e($pathParts['basename'])?></option>
...
<?php if($greportlist[$referenz_tab]["defformat"][$report_id] == 'tcpdf' || $greportlist[$referenz_tab]["defformat"][$report_id] == 'mpdf'){ #REPTYPE# ?>
