...
<TABLE BORDER="0" cellspacing="1" cellpadding="2" width="100%" height=100% class="tabBody">
    ...
    <TR><Th><?=$gview["viewname"]?></Th></TR>

    <TR><TD style="height:53vh;">
...
<div class="row mt-3">
    ...
    <div class="col-md-4 text-center">
        <button type="button" class="btn btn-sm btn-outline-dark" onclick="<?= $confirm ?> document.form1.act.value='view_save';setDrag();document.form1.submit();"><?=$lang[2940]?></button>
