        ...
        <form method="post" action="?lang=<?=e(LANG)?>">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <h1 class="text-center mb-4">Limbas <?=lang('installation')?></h1>

                    <h2 class="mb-3"><?= lang('Information') ?></h2>
                    <p><?=lang('Please enter the following information. Don\'t worry, you can change all these settings again later.')?></p>

                    <div class="row mb-3">
                        <label for="language" class="col-md-4 col-form-label"><?= lang('Language') ?></label>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-3">
                        <label for="dateformat" class="col-md-4 col-form-label"><?= lang('Dateformat') ?></label>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-3">
                        <label for="company" class="col-md-4 col-form-label"><?= lang('Company') ?></label>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-3">
                        <label for="username" class="col-md-4 col-form-label"><?= lang('Username') ?></label>
                        <div class="col-md-8">
                            ...
                            <div class="form-text">
                                <?=lang('User names may only contain alphanumeric characters, spaces, underscores, hyphens and dots.')?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-text">
                                <?=lang('Important: You will need this password to log in. Please keep it in a safe place.')?>
                            </div>
                        </div>
                    </div>


                    <h2 class="mb-3"><?= lang('Select a data package') ?></h2>


                    <?php if(empty($packages) && !$hasClean): ?>
                        <div class="alert alert-danger" role="alert"><?=lang('No installation archive found! Please place at least one under:') . '<br>' . BACKUPPATH?></div>
                    <?php else: ?>
                        <div class="row mb-3">
                            <label for="package-clean" class="col-md-4 col-form-label"><?= lang('Empty') ?></label>
                            <div class="col-md-8">
                                <?php if($hasClean): ?>
                                    ...
                                    <div class="form-text">
                                        <?=lang('This is recommended if you want to start a new project.')?>
                                    </div>
                                <?php else: ?>
                        ...
                        <?php if(!empty($packages)): ?>
                            <hr>
                        <div class="row mb-3">
                            <div class="col-md-4 col-form-label"><?= lang('Filled') ?></div>
                            <div class="col-md-8">
                ...
                <div class="card-footer text-center">
                    <?php if(empty($packages) && !$hasClean): ?>
                        <a class="btn btn-warning" href="?lang=<?=e(LANG)?>"><?=lang('Reload')?></a>
                    <?php else: ?>
                        <button class="btn btn-primary" type="submit"><?=lang('Install Limbas')?></button>
                    <?php endif; ?>
                </div>
            </div>
        </form>
