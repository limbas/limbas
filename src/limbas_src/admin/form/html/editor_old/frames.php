...
<div class="frame-container">
    <iframe name="form_main" src="main_admin.php?&action=setup_form_main&form_id=<?=$form_id?>&form_name=<?=$form_name?>&form_typ=<?=$form_typ?>&referenz_tab=<?=$referenz_tab?>" class="frame-fill"></iframe>
