...
<form action="main_admin.php" method="post" name="form2">
    ...
    <div class="row mb-2">
        ...
        <div class="col-6">
            ...
            <button class="btn btn-primary btn-sm" type="submit" name="show" value="<?=$lang[1061]?>"><?=$lang[1061]?></button>
            <button class="btn btn-warning btn-sm" type="button" onclick="if(confirm('<?=$lang[2153]?>')){ document.form2.empty.value=1; document.form2.submit(); }"><?=$lang[550]?></button>
            <button class="btn btn-danger btn-sm" type="button" onclick="if(confirm('<?=$lang[2287]?>')){ document.form2.delete.value='table'; document.form2.submit(); }"><?=$lang[160]?></button>
        </div>
    </div>
    ...
    <div class="row mb-2">
        <div class="col-6">
            <select name="domaintable" class="form-select form-select-sm">
                <?php
        ...
        <div class="col-6">
            <button class="btn btn-primary btn-sm" type="submit" name="showsys" value="<?=$lang[1061]?>"><?=$lang[1061]?></button>
        </div>
    </div>
    ...
    <?php if ($sqlFavorites) : ?>
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                ...
                <button class="btn btn-primary btn-sm" type="button" onclick="if(confirm('<?=$lang[2287]?>')){ document.form2.delete.value='favorite'; document.form2.submit(); }"><?=$lang[160]?></button>
            </div>
        </div>
    ...
    <textarea id="sqlvalue" name="sqlvalue" <?php if($use_codemirror != 'true'){echo 'class="form-control" style="height:300px;"';}?> ><?= $sqlvalue ?></textarea>
    ...
    <div class="row">
        <div class="col-sm-8">
            <button class="btn btn-primary btn-sm" id="sqlexec" type="submit" value="<?=$lang[1065]?>" name="sqlexec"><?=$lang[1065]?></button>
            <button class="btn btn-primary btn-sm" type="button" name="sqlFavorite" onclick="const name = window.prompt('Name:'); document.form2.sqlFavoriteName.value  = name; document.form2.submit();"><?=$lang[2218]?></button>
            format Code: <input type="checkbox" class="align-middle" value="2" onclick="document.form2.use_codemirror.value=this.checked; document.form2.submit();" <?=($use_codemirror == 'true')?'checked':''?> >
        </div>
        <div class="col-sm-4 text-end text-nowrap">
            <?=$lang[2770]?>: <input type="text" name="sqlexecnum" class="form-control form-control-sm d-inline-block w-auto align-middle" value="<?=$sqlexecnum?>">
        </div>
    </div>
</form>
