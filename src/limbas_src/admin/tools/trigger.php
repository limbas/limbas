            ...
            <div class="tab-pane active">
                    ...
                    <table class="table table-sm table-striped mb-0">
                        ...
                        foreach ($result_trigger as $key1 => $value1) :
                            ...
                            ?>
                            <tr class="table-section"><TD colspan="8"><?=$lang[164]?>: <span class="fw-bold"><?=$key1?></span></TD></tr>
                        ...
                        <?php
                            ...
                            <tr ID="trigger_<?=$value1["id"][$key2]?>" <?php echo ($value1["intern"][$key2]) ? "class=\"table-warning\"" : '';?> >
                                ...
                                <td>
                                <?php if (!$value1["intern"][$key2]): ?>
                                    <i class="lmb-icon lmb-long-arrow-up" style="cursor:pointer" OnClick="document.form1.sortup_definition.value='<?=$value1["id"][$key2]?>';document.form1.submit();"></i> <i class="lmb-icon lmb-long-arrow-down" style="cursor:pointer" OnClick="document.form1.sortdown_definition.value='<?=$value1["id"][$key2]?>';document.form1.submit();"></i>
                                <?php endif; ?>
                                </td>

                                <td>
                                <?php if (!$value1["intern"][$key2]): ?>
                                <i class="lmb-icon lmb-trash" style="cursor:pointer" data-bs-toggle="modal" data-bs-target="#trigger_<?=$value1["id"][$key2]?>_DeleteModal"></i>
                                <?php endif; ?>
                                </td>
                        ...
                        <tfoot>
                            <tr class="border-bottom border-top">
                                <td colspan="8" class="text-end">
                                    ...
                                    <button class="btn btn-sm btn-warning" type="submit" name="syncronize" value="1"> <?= $lang[3224] ?></button>
                                    <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="text-end"><button class="btn btn-sm btn-primary" type="submit" name="add" value="1"><?= $lang[540] ?></button></td>
                            </tr>
                        </tfoot>
                    </table>
