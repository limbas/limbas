...
class LimbasRelation extends LimbasComponent
{
	...
	public function __toString() {
		...
		if (0 < lmb_count($this->objects)) {
			foreach($this->objects as $object) {
				$str .= $object;
			}
		}
		elseif (0 < lmb_count($this->strings)) {
	...
	public function setObjects($objects) {
		$this->log('LimbasRelation(' . $this->refId . ', ' . $this->definition['name'] . ').setObjects(' . lmb_count($objects) . ')');
		$this->objects = array();
	...
	public function hasObjects() {
		return 0 < lmb_count($this->objects);
	}
	...
	public function getObjects() {
		$this->log('LimbasRelation(' . $this->refId . ', ' . $this->definition['name'] . ').getObjects ' . lmb_count($this->objects));
		return $this->objects;
	}
	...
	public function hasStrings() {
		return 0 < lmb_count($this->strings);
	}
