...
<style>
    ...
    #lmb-report-select .form-select-sm{
...
<script src="<?=rtrim($umgvar['url'],'/')?>/assets/js/extra/report/report_select/report_select.js?v=<?=$umgvar['version']?>"></script>
