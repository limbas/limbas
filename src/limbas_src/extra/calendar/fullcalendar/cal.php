 ...
 */ ?>
        ...
        <div class="row">
            ...
            <div class="col-auto pt-1 px-0" id="cal_searchFrameTD"
                 style="<?php $menu_setting = lmbGetMenuSetting();
                 if (!$menu_setting["frame"]["cal"]) {
                     echo 'display:none';
                 } ?>">
                <div id="cal_searchFrame" style="<?= !$menu_setting["frame"]["cal"] ? 'display:none' : '' ?>">
                    <div id="cal_datepicker" class="bg-danger"></div>
                    <div class="w-100 bg-success" id="extsearchtab">
                        <?php
                        # extension
                        ...
                        <div class="row justify-content-center py-1">
                            <div class="col-auto px-1">
                                <input type="button"
                                       value="suchen"
                                       onclick="lmb_calReload(1)">
                            </div>
                            <div class="col-auto px-1">
                                <input type="button"
                                       value="erweitert"
                                       onclick="limbasDetailSearch(event,this,'<?= $gtabid ?>','','lmbCalAjaxContainer')">
                            </div>
                            <div class="col-auto px-1">
                                <input type="button"
                                       value="reset"
                                       onclick="lmb_extsearchclear()">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <div class="container-fluid px-0">
                    ...
                    */ ?>
                    ...
                    <?php /*
                    <div class="row py-1">
                        <div id="iconmenu" class="gtabHeaderSymbolTR">
                            <?php if ($LINK[224] and $cal_viewmode != 3): ?>
                                <i class="lmb-icon lmb-cog"
                                   onclick="limbasDivShow(this,'','viewmenu');"
                                   title="<?= $lang[$LINK['name'][224]] ?>"
                                   style="cursor:pointer;"></i>
                            <?php endif; ?>
                            <i class="lmb-icon lmb-plus-square"
                               onclick="lmb_calNewEvent(event);"
                               title="<?= $lang[1435] ?>"
                               style="cursor:pointer;">
                            </i>
                    ...
                    <?php /*
                            <i class="lmb-icon lmb-page-find"
                               onclick="lmb_calSearchFrame()"
                               title="<?= $lang[2255] ?>"
                               style="cursor:pointer;">
                            </i>
                            <?php if ($extrasmenu): ?>
                                <i class="lmb-icon lmb-puzzle-piece"
                                   onclick="limbasDivShow(this,'','extrasmenu');"
                                   title="<?= $lang[1939] ?>"
                                   style="cursor:pointer;">
                                </i>
                            <?php endif; ?>
                            ...
                            if ($gfield[$gtabid]["md5tab"][$gtab['params1'][$gtabid]]): ?>
                                <span class="tabpoolItemInactive lmb-tabpoolItemnohover"
                                      title="<?= $lang[2854] ?>"><i
                                            class="lmb-icon lmb-calendar-alt2"></i>
                                </span>
                                <span id="tzone_resourceMonth"
                                      style="cursor:pointer;"
                                      onclick="lmb_calView('resourceMonth');"
                                      class="fw-bold px-1 <?= $cal_viewmode == 'resourceMonth' ? "tabpoolItemActive" : "tabpoolItemInactive" ?>">
                                    <?= $lang[1437]; ?>
                                </span>
                                <span id="tzone_resourceWeek"
                                      style="cursor:pointer;"
                                      onclick="lmb_calView('resourceWeek');"
                                      class="fw-bold px-1 <?= $cal_viewmode == 'resourceWeek' ? "tabpoolItemActive" : "tabpoolItemInactive" ?>">
                                    <?= $lang[1436]; ?>
                                </span>
                                <span id="tzone_resourceDay"
                                      style="cursor:pointer;"
                                      onclick="lmb_calView('resourceDay');"
                                      class="fw-bold px-1 <?= $cal_viewmode == 'resourceDay' ? "tabpoolItemActive" : "tabpoolItemInactive" ?>">
                                    <?= $lang[1435]; ?>
                                </span>
                            <?php else: ?>
                                <span title="<?= $lang[2853] ?>"
                                      class="tabpoolItemInactive lmb-tabpoolItemnohover">
                                    <i class="lmb-icon-cus lmb-cal-day"></i>
                                </span>
                                <span id="tzone_month"
                                      style="cursor:pointer;"
                                      value="<?= $lang[1437]; ?>"
                                      onclick="lmb_calView('dayGridMonth');"
                                      class="fw-bold px-1 <?= $cal_viewmode == 'month' ? "tabpoolItemActive" : "tabpoolItemInactive" ?>">
                                <?= $lang[1437]; ?>
                                </span>
                                <span id="tzone_agendaWeek"
                                      style="cursor:pointer;"
                                      value="<?= $lang[1436]; ?>"
                                      onclick="lmb_calView('timeGridWeek');"
                                      class="fw-bold px-1 <?= $cal_viewmode == 'agendaWeek' ? "tabpoolItemActive" : "tabpoolItemInactive" ?>">
                                    <?= $lang[1436]; ?>
                                </span>
                                <span id="tzone_agendaDay"
                                      style="cursor:pointer;"
                                      value="<?= $lang[1435]; ?>"
                                      onclick="lmb_calView('timeGridDay');"
                                      class="fw-bold px-1 <?= $cal_viewmode == 'agendaDay' ? "tabpoolItemActive" : "tabpoolItemInactive" ?>">
                                    <?= $lang[1435]; ?>
                                </span>
                            <?php endif; ?>
                            ...
                            <span id="tzone_dayGridWeek"
                                  style="cursor:pointer;"
                                  onclick="lmb_calView('dayGridWeek');"
                                  class="fw-bold px-1">
                                    <?= "dayGridWeek" ?>
                                </span>
                            <span id="tzone_dayGridDay"
                                  style="cursor:pointer;"
                                  onclick="lmb_calView('dayGridDay');"
                                  class="fw-bold px-1">
                                    <?= "dayGridDay" ?>
                                </span>
                            ...
                            <span id="tzone_listWeek"
                                  style="cursor:pointer;"
                                  onclick="lmb_calView('listWeek');"
                                  class="fw-bold px-1">
                                    <?= "listWeek" ?>
                            </span>
                            */ ?>
