...
<nav class="navbar navbar-expand-sm navbar-light bg-nav mb-2">
            ...
            <?php if($session['symbolbar']): ?>
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php if($gtab['edit'][$gtabid] && $action == 'gtab_change' AND !$readonly): ?>
                        <li class="nav-item">
                            <?= \gtab\forms\LMBAction::ren(197,'icon'); // speichern ?>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php if(!empty($ID)): ?>
                        ...
                        <?php if($gtab["edit"][$gtabid] && !$isview): ?>
                            ...
                            <?php if($action == "gtab_change"): ?>
                                ...
                                echo \gtab\forms\LMBAction::ren(6,'icon', event: 'onclick="' . $onClickShowContext . $onClickOpenMenu . '"');
                                ?>


                            <?php elseif($gtab["edit"][$gtabid] && !$readonly): ?>
                                <?= \gtab\forms\LMBAction::ren(3,'icon'); // bearbeiten ?>
                            <?php endif; ?>
                        <?php endif; ?>
                        ...
                        <?php if($gtab['add'][$gtabid] && $action == 'gtab_change' && !$readonly): ?>
                            <li class="nav-item">
                                <?= \gtab\forms\LMBAction::ren(1,'icon'); // neuer Datensatz ?>
                            </li>
                        <?php endif; ?>

                        <?php if($gtab['add'][$gtabid] && $gtab['copy'][$gtabid] && !$readonly): ?>
                            <li class="nav-item">
                                <?= \gtab\forms\LMBAction::ren(201,'icon'); // Datensatz kopieren ?>
                            </li>
                        <?php endif; ?>

                        <?php if($gtab['ver'][$gtabid] && $gtab['add'][$gtabid] && !$readonly): ?>
                            <li class="nav-item">
                                <?= \gtab\forms\LMBAction::ren(235,'icon'); // versionieren ?>
                            </li>
                        <?php endif; ?>

                        <?php if($gtab['delete'][$gtabid] && !$readonly): ?>
                            <li class="nav-item">
                                <?= \gtab\forms\LMBAction::ren(11,'icon'); // löschen ?>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if($gtab['lock'][$gtabid] && !$gresult[$gtabid]['LOCK']['USER'][$ID] && !$readonly): ?>
                            <li class="nav-item">
                                <?php if($gresult[$gtabid]['LOCK']['STATIC'][$ID]): ?>
                                    <?= \gtab\forms\LMBAction::ren(271,'icon'); // freigeben ?>
                                <?php else: ?>
                                    <?= \gtab\forms\LMBAction::ren(270,'icon'); // sperren ?>
                                <?php endif; ?>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if($gtab['hide'][$gtabid] && !$readonly): ?>
                            <li class="nav-item">
                                <?php if($gresult[$gtabid]['DEL'][0]): ?>
                                    <?= \gtab\forms\LMBAction::ren(166,'icon'); // Archiv wiederherstellen ?>
                                <?php else: ?>
                                    <?= \gtab\forms\LMBAction::ren(164,'icon'); // archivieren ?>
                                <?php endif; ?>
                            </li>
                        <?php endif; ?>

                        <li class="nav-item">
                            <?= \gtab\forms\LMBAction::ren(10,'icon'); // Liste ?>
                        </li>

                        <?php if($GLOBALS["greportlist_exist"] && ($LINK[175] || $LINK[176] OR $LINK[315])): ?>
                            <li class="nav-item">
                                <?= \gtab\forms\LMBAction::ren(131,'icon'); // Berichte ?>
                            </li>
                            <?php if($LINK[315]): ?>
                                <?= \gtab\forms\LMBAction::ren(315,'icon'); // Berichte neu ?>
                            <?php endif; ?>
                        <?php endif; ?>

                        <?php if($GLOBALS['gformlist_exist']): ?>
                            <li class="nav-item">
                                <?= \gtab\forms\LMBAction::ren(132,'icon'); // Formulare ?>
                            </li>
                        <?php endif; ?>

                        <?php if($GLOBALS['gdiaglist_exist'] AND $LINK[232]): ?>
                            <li class="nav-item">
                                <?= \gtab\forms\LMBAction::ren(232,'icon'); // Diagramme ?>
                            </li>
                        <?php endif; ?>


                        <li class="nav-item">
                            <?= \gtab\forms\LMBAction::ren(109,'icon'); // Wiedervorlage ?>
                        </li>
