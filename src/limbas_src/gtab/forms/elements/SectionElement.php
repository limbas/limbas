...
class SectionElement extends LMBFormElement
{
    
    protected LMBField|null $field;
    
    protected array $children;
    
    public function __construct(LMBField $lmbField = null) {
    ...
    public function addChild(LMBFormElement $LMBFormElement) {
        $this->children[] = $LMBFormElement;
    }
    ...
    public function getId(): int {
        return $this->field === null ? 0 : $this->field->getId();
    }
    ...
    public function getLabel(): string {
        return $this->field === null ? 'General' : $this->field->getLabel();
    }
