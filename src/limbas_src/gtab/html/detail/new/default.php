...
<div class="p-3 form-legacy">
    ...
    <?php
    require( COREPATH . 'gtab/forms/templates/linktags.php');
    ?>
    
    <?php
    require( COREPATH . 'gtab/forms/templates/menu.php');
    ?>
    
    <?php
    require( COREPATH . 'gtab/forms/templates/notices.php');
    ?>
                ...
                <div class="row">
                    ...
                    <?php if ($action != 'gtab_deterg' && !$readonly): ?>
                        <div class="col-md-6 ps-0">
                            ...
                            <button type="button" class="btn btn-primary submit" name="lmbSbmClose" id="lmbSbmClose_<?=$gtabid?>_<?=$ID?>" onclick="document.form1.action.value='gtab_change'; send_form(1,0,1);" style="display: none"><?=$lang[2796]?></button>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
