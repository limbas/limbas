...
<div class="p-3 d-flex flex-column">
    ...
    <div class="row">
        ...
        <div class="input-group input-group-sm mb-3">
            ...
            <select id="globalFilter" class="form-select" onchange="document.form1.snap_id.value=this.value;document.form2.snap_id.value=this.value;send_form(1,2,1,1,1,1);"><option value='0'>
                <?php
